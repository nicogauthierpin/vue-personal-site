...
Vue.component('about-page', {
  template : '\
    <section id="about">\
      ...
      <p>I am currently a Senior Developer at the Creative Technology team at <a href="https://wearesparks.com">Sparks</a>, where we build live and digital brand experiences. Prior to that I worked as Web Developer and Interactive Manager at <a href="https://gunnjerkens.com/">Gunn | Jerkens</a>, a marketing agency in Long Beach, CA, and I freelanced as a web and graphic designer for over 10 years. <a href="http://2016.nicolas.gauthier-pin.com/">My (very old) freelance portfolio is still online.</a></p>\
      <p>Outside work, I\'m an avid cyclist and I volunteer my time for safe streets causes, serving on the board of <a href="https://bikelb.com">Bike Long Beach</a> and as an active member of <a href="https://carlitelb.org">Car-Lite Long Beach</a></p> I also help with the <a href="http://longbeachcommunitytheater.com/">Long Beach Community Theater</a>, lending a hand with everything web and whatever else is needed.</p>\
      <p>In the past I was also part of the local Wordpress and developer community in Long Beach, serving as one of the organizers of the Long Beach chapter of the <a href="https://www.meetup.com/WPLosAngeles/">Wordpress Los Angeles</a> meetup, the organizing team of <a href="https://2019.longbeach.wordcamp.org/">WordCamp Long Beach 2019</a>, and a regular attendant of the <a href="http://codeandcoffeelb.org/">Code&&Coffee meetup</a>.</p>\
      </div>\
    </section>'
});
